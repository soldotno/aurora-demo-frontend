 ...
 */
const DemoModuleWithRandomization = React.createClass({
  render() {
    /**
...
const extendWithAuroraFunctionality = compose(
   ...
   */
  withData({
    fetchData: require('./services/get-randomized-data'),
    dataProp: 'data',
 ...
 */
module.exports = extendWithAuroraFunctionality(DemoModuleWithRandomization);
