 ...
 */
const DemoModuleWithPersonalization = React.createClass({
  render() {
    /**
...
const extendWithAuroraFunctionality = compose(
   ...
   */
  withData({
    fetchData: require('./services/get-personalized-data'),
    dataProp: 'data',
 ...
 */
module.exports = extendWithAuroraFunctionality(DemoModuleWithPersonalization);
